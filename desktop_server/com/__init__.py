...
__all__ = [
    ...
    "solidworks_equations_router",
    "SOLIDWORKS_EQUATIONS_AVAILABLE",
    "solidworks_display_router",
    "SOLIDWORKS_DISPLAY_AVAILABLE",
    "solidworks_materials_router",
    "SOLIDWORKS_MATERIALS_AVAILABLE",
    "solidworks_bodies_router",
    "SOLIDWORKS_BODIES_AVAILABLE",
    "solidworks_rendering_router",
    "SOLIDWORKS_RENDERING_AVAILABLE",
    "solidworks_sensors_router",
    "SOLIDWORKS_SENSORS_AVAILABLE",
    "solidworks_macros_router",
    "SOLIDWORKS_MACROS_AVAILABLE",
    "solidworks_design_tables_router",
    "SOLIDWORKS_DESIGN_TABLES_AVAILABLE",
    "solidworks_pack_and_go_router",
