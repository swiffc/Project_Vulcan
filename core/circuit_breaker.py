...
def get_circuit_breaker() -> CircuitBreakerAdapter:
    ...
    if _breaker is None:
        ...
        _breaker.register("trading", CircuitConfig(failure_threshold=3, calls_per_minute_limit=5))
        _breaker.register("cad", CircuitConfig(failure_threshold=5, calls_per_minute_limit=10))
        _breaker.register("desktop", CircuitConfig(failure_threshold=10, calls_per_minute_limit=60))
    return _breaker
